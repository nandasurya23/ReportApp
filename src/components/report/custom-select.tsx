  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      >
        ...
        <span className={`text-slate-600 transition ${open ? "rotate-180" : ""}`} aria-hidden="true">▾</span>
      </button>
      {open && (
        <div
          id={listboxId}
          role="listbox"
          aria-label={label}
          className="absolute z-30 mt-1 max-h-52 w-full overflow-auto rounded-xl border border-slate-300 bg-white p-1 shadow-xl"
        >
          {options.map((option) => {
